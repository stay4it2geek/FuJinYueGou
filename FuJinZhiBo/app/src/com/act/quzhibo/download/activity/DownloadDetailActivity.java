  ...
  protected void initData() {
    ...
    bt_action.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ToastUtil.showToast(DownloadDetailActivity.this,"revmoed"+downloadInfo.getStatus());
...
//            Create new download task
          File d = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), "downlaod");
          ToastUtil.showToast(DownloadDetailActivity.this,d.getAbsoluteFile().getAbsolutePath()+"path");
