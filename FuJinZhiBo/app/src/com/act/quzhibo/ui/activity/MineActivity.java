...
public class MineActivity extends BaseActivity {
    ...
    @Bind(R.id.vipLevel)
    TextView vipLevel;
    @Bind(R.id.vip_levelimg)
    ImageView vip_levelimg;
    @Bind(R.id.sexAndAge)
    TextView sexAndAge;
    ...
    @OnClick({R.id.shopping_cart_layout, R.id.circleAvatar, R.id.avaterlayout,
            R.id.makemoneyLayoout, R.id.checkoutMoneyLayout, R.id.shareManagerLayoout,
                        ...
                        public void run() {
                            ...
                            switch (view.getId()) {
                                ...
                                case R.id.myIMG_download_layout:
                                    ...
                                    photoIntent.setClass(MineActivity.this, DownloadManagerActivity.class);
    ...
    public void onResume() {
        ...
        if (rootUser != null) {
            ...
            vip_coins.setText(rootUser.vipConis != null && rootUser.vipConis > 0 ? "(已有" + rootUser.vipConis + "趣币)" : "您趣币不足");
            ...
            if (!TextUtils.isEmpty(rootUser.sex) && rootUser.sex.equals("男")) {
                if (rootUser.vipConis != null && rootUser.vipConis > 0) {
                    if (0 < rootUser.vipConis && rootUser.vipConis < 1000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_0);
                    } else if (1000 < rootUser.vipConis && rootUser.vipConis < 2000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_1);
                    } else if (2000 < rootUser.vipConis && rootUser.vipConis < 3000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_2);
                    } else if (3000 < rootUser.vipConis && rootUser.vipConis < 4000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_3);
                    } else if (4000 < rootUser.vipConis && rootUser.vipConis < 5000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_4);
                    } else if (5000 < rootUser.vipConis && rootUser.vipConis < 6000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_5);
                    } else if (6000 < rootUser.vipConis && rootUser.vipConis < 7000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_6);
                    } else if (7000 < rootUser.vipConis && rootUser.vipConis < 7000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_7);
                    } else if (8000 < rootUser.vipConis && rootUser.vipConis < 9000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_8);
                    } else if (9000 < rootUser.vipConis && rootUser.vipConis < 10000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_9);
                    } else if (rootUser.vipConis > 10000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_male_10);
                    }
                }
            }
            if (!TextUtils.isEmpty(rootUser.sex) && rootUser.sex.equals("女")) {
                if (rootUser.vipConis != null && rootUser.vipConis > 0) {
                    if (0 < rootUser.vipConis && rootUser.vipConis < 1000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_0);
                    } else if (1000 < rootUser.vipConis && rootUser.vipConis < 2000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_1);
                    } else if (2000 < rootUser.vipConis && rootUser.vipConis < 3000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_2);
                    } else if (3000 < rootUser.vipConis && rootUser.vipConis < 4000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_3);
                    } else if (4000 < rootUser.vipConis && rootUser.vipConis < 5000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_4);
                    } else if (5000 < rootUser.vipConis && rootUser.vipConis < 6000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_5);
                    } else if (6000 < rootUser.vipConis && rootUser.vipConis < 7000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_6);
                    } else if (7000 < rootUser.vipConis && rootUser.vipConis < 7000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_7);
                    } else if (8000 < rootUser.vipConis && rootUser.vipConis < 9000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_8);
                    } else if (9000 < rootUser.vipConis && rootUser.vipConis < 10000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_9);
                    } else if (rootUser.vipConis > 10000) {
                        vip_levelimg.setBackgroundResource(R.drawable.level_female_10);
