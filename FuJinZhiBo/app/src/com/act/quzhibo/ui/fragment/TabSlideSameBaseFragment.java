...
public abstract class TabSlideSameBaseFragment extends Fragment {
    ...
    protected void initUiView() {
        ...
        ((TextView) view.findViewById(R.id.title_text)).setText(getChangeText());
        view.findViewById(R.id.title_text).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listner.onChangeFragment(getChangeText());
            }
        });
    }
