...
public class MediaModel implements OnDownloadFileChangeListener {
    ...
    public MediaModel(String mediaId, String mediaUrl, String mediaCoverUrl, String mediaName,
    ...
    public void onDownloadFileCreated(DownloadFileInfo downloadFileInfo) {
        ...
        if (downloadFileInfo != null && downloadFileInfo.getUrl() != null && downloadFileInfo.getUrl().equals
            ...
            try {
                ...
                Dao<MediaModel, Integer> dao = mMediaDbHelper.getDao(MediaModel.class);
        ...
        if (downloadFileInfo != null && downloadFileInfo.getUrl() != null && downloadFileInfo.getUrl().equals
            ...
            if (this.mDownloadFileInfo == null) {
                try {
                    ...
                    UpdateBuilder builder = mMediaDbHelper.getDao(MediaModel.class).updateBuilder();
                    builder.where().eq(MediaModel.COLUMN_NAME_OF_FIELD_MEDIA_URL, downloadFileInfo.getUrl());
    ...
    public void onDownloadFileDeleted(DownloadFileInfo downloadFileInfo) {
        ...
        if (downloadFileInfo != null && downloadFileInfo.getUrl() != null && downloadFileInfo.getUrl().equals
            ...
            try {
                ...
                DeleteBuilder builder = mMediaDbHelper.getDao(MediaModel.class).deleteBuilder();
                builder.where().eq(MediaModel.COLUMN_NAME_OF_FIELD_MEDIA_URL, mMediaUrl);
