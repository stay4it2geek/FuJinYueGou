...
public class MyApplicaition extends Application {
    ...
    static {
        ...
        cityKeySrc.put("108", "合肥市");
        cityKeySrc.put("116", "芜湖市");
        cityKeySrc.put("101", "蚌埠市");
        cityKeySrc.put("110", "淮南市");
        cityKeySrc.put("113", "马鞍山市");
        cityKeySrc.put("109", "淮北市");
        cityKeySrc.put("115", "铜陵市");
        cityKeySrc.put("100", "安庆市");
        cityKeySrc.put("107", "黄山市");
        cityKeySrc.put("106", "阜阳市");
        cityKeySrc.put("114", "宿州市");
        cityKeySrc.put("104", "巢湖市");
        cityKeySrc.put("112", "六安市");
        cityKeySrc.put("102", "亳州市");
        cityKeySrc.put("105", "池州市");
        cityKeySrc.put("117", "宣城市");
        ...
        cityKeySrc.put("343", "赣州市");
        cityKeySrc.put("338", "枣庄市");
        cityKeySrc.put("334", "日照市");
        cityKeySrc.put("335", "莱芜市");
        cityKeySrc.put("279", "聊城市");


        cityKeySrc.put("206", "商丘市");
        cityKeySrc.put("212", "郑州市");
        cityKeySrc.put("198", "安阳市");
        cityKeySrc.put("207", "新乡市");
        cityKeySrc.put("209", "许昌市");
        cityKeySrc.put("205", "平顶山市");
        cityKeySrc.put("208", "信阳市");
        cityKeySrc.put("204", "南阳市");
        cityKeySrc.put("201", "开封市");
        cityKeySrc.put("202", "洛阳市");
        cityKeySrc.put("210", "焦作市");
        cityKeySrc.put("200", "赣州市");
        ...
        cityKeySrc.put("214", "濮阳市");
        cityKeySrc.put("206", "驻马店市");
        cityKeySrc.put("205", "三门峡市");
        cityKeySrc.put("206", "濮阳市");
        cityKeySrc.put("206", "濮阳市");
        cityKeySrc.put("206", "濮阳市");
        cityKeySrc.put("206", "濮阳市");
